require("fzf-lua").setup {
  ...
  files = {
    ...
    git_icons = true,
    no_ignore = true,
    fd_opts = "--color=never --type f --hidden --follow --exclude .git --exclude .venv --exclude node_modules --exclude venv --exclude __pycache__ --exclude .pytest_cache --exclude dist --exclude build --exclude target --exclude vendor",
  },
}
